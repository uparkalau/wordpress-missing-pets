...
function missing_pets_directory_scripts() {
    ...
    // Enqueue Custom CSS
    wp_enqueue_style( 'missing-pets-style', get_template_directory_uri() . '/assets/css/custom.css' );
    ...
    // Enqueue Custom JS
    wp_enqueue_script( 'missing-pets-script', get_template_directory_uri() . '/assets/js/custom.js', array('jquery'), '1.0.0', true );
